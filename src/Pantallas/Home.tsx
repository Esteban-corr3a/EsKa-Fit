        ...
        <SafeAreaView style={estilos.contenedorPrincipal}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={estilos.contenidoScroll}>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={estilos.scrollRutinas}>
                    <TarjetaRutina titulo="Upper Body" nivel="Intermedio" tiempo="45 min" img="https://images.unsplash.com/photo-1581009146145-b5ef03a7403f?w=500&auto=format" />
                    <TarjetaRutina titulo="Core Fuerte" nivel="Principiante" tiempo="20 min" img="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=500&auto=format" />
                </ScrollView>
...
const CardProgreso = ({ icon, valor, desc, color, isMCI = false }: any) => (
    <View style={estilos.miniCardProgreso}>
        <View style={estilos.filaProgreso}>
            {isMCI ? <MaterialCommunityIcons name={icon} size={18} color={color} /> : <Ionicons name={icon} size={18} color={color} />}
...
const estilos = StyleSheet.create({
    ...
    headerSuperior: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingVertical: 15 },
    perfilGrupo: { flexDirection: 'row', alignItems: 'center' },
    fotoPerfilHeader: { width: 50, height: 50, borderRadius: 25, borderWidth: 2, borderColor: COLORES.primario },
    textoGrupoHeader: { marginLeft: 12 },
    textoHola: { color: COLORES.textoSecundario, fontSize: 14 },
    textoNombreUser: { color: COLORES.textoPrincipal, fontSize: 18, fontWeight: 'bold' },
    botonConfig: { width: 45, height: 45, backgroundColor: COLORES.tarjeta, borderRadius: 12, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: COLORES.borde },
    contenidoScroll: { paddingHorizontal: 20 },
    botonCamaraRapida: { backgroundColor: COLORES.tarjeta, borderRadius: 20, padding: 15, flexDirection: 'row', alignItems: 'center', marginBottom: 20, borderWidth: 1, borderColor: COLORES.borde },
    iconoCamaraCirculo: { width: 50, height: 50, borderRadius: 25, backgroundColor: COLORES.primario, justifyContent: 'center', alignItems: 'center' },
    ...
    overlayNegro: { padding: 20, backgroundColor: 'rgba(0,0,0,0.35)', flex: 1, justifyContent: 'center' },
    ...
    badgeDetalle: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.15)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20 },
    textoBadge: { color: '#FFF', fontSize: 12, marginLeft: 5 },
    botonEmpezar: { backgroundColor: COLORES.primario, flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 20, borderRadius: 30, alignSelf: 'flex-start' },
    ...
    cardRutina: { width: 165, height: 230, backgroundColor: COLORES.tarjeta, borderRadius: 20, marginRight: 15, overflow: 'hidden', borderWidth: 1, borderColor: COLORES.borde },
    ...
    miniCardProgreso: { width: (width - 60) / 3, backgroundColor: COLORES.tarjeta, padding: 15, borderRadius: 20, alignItems: 'center', borderWidth: 1, borderColor: COLORES.borde },
